...
export class FlexibleLeverageStrategyAdapterBTC__getExecutionResultValue0Struct extends ethereum.Tuple {
...
export class FlexibleLeverageStrategyAdapterBTC__getIncentiveResultValue0Struct extends ethereum.Tuple {
...
export class FlexibleLeverageStrategyAdapterBTC__getMethodologyResultValue0Struct extends ethereum.Tuple {
...
export class FlexibleLeverageStrategyAdapterBTC__getStrategyResultValue0Struct extends ethereum.Tuple {
...
export class FlexibleLeverageStrategyAdapterBTC extends ethereum.SmartContract {
  static bind(address: Address): FlexibleLeverageStrategyAdapterBTC {
    return new FlexibleLeverageStrategyAdapterBTC(
  ...
  getExecution(): FlexibleLeverageStrategyAdapterBTC__getExecutionResultValue0Struct {
    let result = super.call(
      "getExecution",
    ...
    return changetype<
      FlexibleLeverageStrategyAdapterBTC__getExecutionResultValue0Struct
    >(result[0].toTuple());
  }
  ...
  getIncentive(): FlexibleLeverageStrategyAdapterBTC__getIncentiveResultValue0Struct {
    let result = super.call(
      "getIncentive",
    ...
    return changetype<
      FlexibleLeverageStrategyAdapterBTC__getIncentiveResultValue0Struct
    >(result[0].toTuple());
  }
  ...
  getMethodology(): FlexibleLeverageStrategyAdapterBTC__getMethodologyResultValue0Struct {
    let result = super.call(
      "getMethodology",
    ...
    return changetype<
      FlexibleLeverageStrategyAdapterBTC__getMethodologyResultValue0Struct
    >(result[0].toTuple());
  }
  ...
  getStrategy(): FlexibleLeverageStrategyAdapterBTC__getStrategyResultValue0Struct {
    let result = super.call(
      "getStrategy",
    ...
    return changetype<
      FlexibleLeverageStrategyAdapterBTC__getStrategyResultValue0Struct
    >(result[0].toTuple());
  }
